...
export default function StaffMaintenanceScreen() {
  ...
  const { routines, routineGroups, loading, refreshing, actionError, refresh, uploadEvidence } =
    ...
    <ScreenBackground>
      ...
      >
        ...
        <View style={styles.section}>
          <PrimaryButton label="Registrar evidencia" onPress={() => setSheetOpen(true)} />
        </View>
        ...
        {routines.length === 0 ? (
          <GlassCard style={styles.mt}>
            <Text style={{ color: theme.textMuted, fontSize: 14 }}>
              Sin actividades programadas. El administrador publicará el programa aquí.
            </Text>
          </GlassCard>
        ) : (
                ...
                {group.items.map((routine) => {
                  ...
                  return (
                    <GlassCard key={routine.id} style={styles.routineCard}>
                      ...
                      >
                        <Text style={[styles.link, { color: theme.accent }]}>Subir evidencia de esta actividad</Text>
                      </Pressable>
                    </GlassCard>
                  );
                })}
      ...
      <KeyboardFormSheet visible={sheetOpen} onClose={() => setSheetOpen(false)} title="Registrar evidencia">
